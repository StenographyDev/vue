...
declare type ModuleOptions = {
 ...
 This code is doing the following things.
  It's a function that takes an AST element as input and returns an AST element or nothing.
  The returned value can be anything, including null (which means no transformation).
    If you return something, it will replace the original node in the tree.
    If you don't return anything, then your code won't do any transformations on this node.
